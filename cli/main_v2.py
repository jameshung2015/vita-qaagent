#!/usr/bin/env python3
"""
VITA QA Agent CLI v2 - Enhanced Test Case Generation Tool
...
app = typer.Typer(help="VITA QA Agent v2 - 增强版自动化测试用例生成工具")
console = Console()
...
def generate(
    ...
    示例:
        # 单个本地文件
        python cli/main_v2.py generate --prd metric/识人识物_用例设计原则与示例.md

        # 多个本地文件
        python cli/main_v2.py generate --prd prd1.md --prd prd2.md --project multi_module

        # 从URL加载
        python cli/main_v2.py generate --prd https://example.com/prd.md --project remote

        # 混合本地和远程
        python cli/main_v2.py generate --prd local.md --prd https://example.com/remote.md
    """
    # Load environment
    load_env()
    ...
    console.print("\n[bold cyan]VITA QA Agent v2 - 增强版测试用例生成[/bold cyan]\n")
